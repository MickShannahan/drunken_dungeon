...
/** @type {string} */
const CACHE_VERSION = '1766379858|35605088444';
/** @type {string} */
const CACHE_PREFIX = 'Drunken_Dungeon-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'drunken_dungeon_release.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["drunken_dungeon_release.html","drunken_dungeon_release.js","drunken_dungeon_release.offline.html","drunken_dungeon_release.icon.png","drunken_dungeon_release.apple-touch-icon.png","drunken_dungeon_release.audio.worklet.js","drunken_dungeon_release.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["drunken_dungeon_release.wasm","drunken_dungeon_release.pck","drunken_dungeon_release.side.wasm"];
